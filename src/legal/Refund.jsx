      ...
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden border border-slate-200">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="flex flex-col gap-1 border-b border-slate-100 pb-6">
            ...
            <p><span className="font-bold text-slate-900">Operated by:</span> Aeth-Meet (Individual developer)</p>
          </div>
          ...
          <section className="space-y-3">
            ...
            <p className="text-slate-600">Aeth-Meet reserves the right to update this policy. Updated versions will be posted within the app.</p>
          </section>
